...
config_file="/datadrive3/DeGCN_pytorch/work_dir/ntu120/csub/degcn/config.yaml"
work_dir="work_dir/ntu120/csub/degcn"
...
do
    ...
    python3 main.py --config "$config_file" --work-dir "$work_dir" --phase test --save-score True --weights "$work_dir/20250217_233519/epoch_80_78720.pt" --device 0
